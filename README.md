...
$ swag init
```
4. Download [gin-swagger](https://github.com/daqiancode/iris-swagger) by using:
```sh
...
```go
import "github.com/swaggo/iris-swagger" // gin-swagger middleware
...
import (
	...
	ginSwagger "github.com/daqian/iris-swagger"
...
func main() {
	...
	r.Get("/swagger/*any", irisSwagger.DisablingWrapHandler(swaggerFiles.Handler, "NAME_OF_ENV_VARIABLE"))
